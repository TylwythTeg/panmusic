...
#print(st._check_input("ACE"))

print(st.find("AC#E"))
print(st.find("ACEG"))
print("-",st.find("CEG"))
print(st.find_all("CEG"))

print(st.word[108:111])
print(st.word[131:134])
print(st.word[281:284])
print(st.word[431:284])
print(st.word[467:284])
print(st.word[954:284])
print(st.word[960:284])
print(st.word[966:284])
print(st.word[462:284])
print(st.word[865:284])
print(st.word[870:284])
print(st.word[875:284])
print(st.word[875:284])



#print(st.get_full_index("ACE"))
#i = st.get_full_index("ABE")
#print(st.word[i[0]-1:i[1]+1])

#########
#Get the index and subtract one from index and use :(if dict_of_valid_characters_for_stamp.get(index, None) == None): 
#   to determine if this is a terminal. if it is this is our start point.
#Do the same for the end and add + 1, and we know the end point of the string
# -1 is only for finding fingerprint from suffix
#########
...
#print(st._generalized_word_starts("A,C#,E"))
